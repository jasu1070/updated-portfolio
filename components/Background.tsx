...
const Background: React.FC = () => {
  return (
    <div className="fixed inset-0 -z-20 overflow-hidden pointer-events-none">
      ...
      {/* Animated industrial glows (Refined for light theme) */}
      <motion.div
        animate={{
          x: [0, 80, -40, 0],
          y: [0, -40, 40, 0],
        ...
        className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-sky-200/20 blur-[150px] rounded-full"
      />
      ...
      <motion.div
        ...
        className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-emerald-200/20 blur-[150px] rounded-full"
      />
